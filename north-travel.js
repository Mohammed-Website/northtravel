...
const sectionData = [

    {
        ...
        main_image_1: {
            ...
            text: 'عرض طرابزون - بشرى - مدينة الرضا - هاني باريس',
        },
        ...
        main_image_2: {
            ...
            text: 'عرض طرابزون - حيات شرق - طهران - جوار الملك',
        },
        ...
        main_image_3: {
            ...
            text: 'عرض طرابزون - سايه - الماسا - أطلس',
        },
    },
...
function openFullScreenImage(mainSrc, subImages, text) {
    ...
    whatsappButton.href = `https://wa.me/+97338811136?text=طلب%20حجز%20هذا%20العرض:%0A%0Ahttps://mohammed-website.github.io/northtravel/${encodeURIComponent(mainSrc)}`;
